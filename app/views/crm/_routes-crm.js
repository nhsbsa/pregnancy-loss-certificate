...
router.get('/crm/v4/search', function (req, res) {
  // check for clear
  ...
  return res.render('/crm/v4/search', {
...
// start page choice
router.post("/crm/v4/start-choice", function (req, res) {
  // grab choice
  let choice = req.session.data['start-choice']
  if (choice === 'status'){
    res.redirect('/crm/v4/search')
  } else if (choice === 'request'){
    res.redirect('/crm/v4/request')
  } else if (choice === 'request2'){
    res.redirect('/crm/v4/request2')
  }
});

router.post("/crm/v4/get-results", function (req, res) {
  // grab search type
  let type = []
  let term = ''
...
router.get('/crm/v4/results', function (req, res) {
  // check for data
  ...
  return res.render('/crm/v4/results', {
