...
router.post(/multy-certcya/, (req, res) => {

 
  const CertificateMultcheckDetails = req.session.data['Twin']

  if (CertificateMultcheckDetails == 'yes') {
    res.redirect('check-your-answers-cert-2');
  } else {
