...
router.post("/beta/v10-copy/enter-location-uk-post/", (req, res) => {
...
router.post("/beta/v10-copy/baby-loss-in-england-post/", (req, res) => {
...
router.post("/beta/v10-copy/living-in-england-post/", (req, res) => {
...
router.post("/beta/v10-copy/loss-in-5-years-post/", (req, res) => {
...
router.post("/beta/v10-copy/relation-to-baby-post/", (req, res) => {
...
router.post("/beta/v10-copy/nhs-number-post/", (req, res) => {
...
router.post("/beta/v10-copy/enter-date-of-birth/", (req, res) => {
  res.redirect('enter-date-of-birth');
})

router.post("/beta/v10-copy/enter-date-of-birth-parent/", (req, res) => {
  res.redirect('enter-date-of-birth-parent');
})

// set a variable once all demographic questions are asked
router.get("/beta/v10-copy/check-your-details/", function (req, res) {
  req.session.data['checkpage-reached'] = "true"
  return res.render('beta/v10-copy/check-your-details')
})

router.post("/beta/v10-copy/get-security-code-post/", (req, res) => {
    res.redirect('enter-security-code');
})

router.post("/beta/v10-copy/confirm-postal-address-post/", (req, res) => {
...
router.post("/beta/v10-copy/add-parent-post/", (req, res) => {
...
router.post("/beta/v10-copy/sex-of-baby-post/", (req, res) => {
...
router.get("/beta/v10-copy/check-your-answers/", function (req, res) {
  req.session.data['answerpage-reached'] = "true"
  return res.render('beta/v10-copy/check-your-answers')
})

///// PARENT 2 /////

router.post("/beta/v10-copy/parent2/nhs-number-post/", (req, res) => {
  const NHSNumber = req.session.data['knows-nhs-number']
  if (NHSNumber === 'No') {
    res.redirect('what-is-your-name');
  } else {
...
router.post("/beta/v10-copy/parent2/enter-date-of-birth/", (req, res) => {
  res.redirect('enter-date-of-birth');
})

// set a variable once all demographic questions are asked
router.get("/beta/v10-copy/parent2/check-your-details/", function (req, res) {
  req.session.data['checkpage-reached'] = "true"
  return res.render('beta/v10-copy/parent2/check-your-details')
})

router.post("/beta/v10-copy/parent2/get-security-code-post/", (req, res) => {
  res.redirect('enter-security-code');
})

router.post("/beta/v10-copy/parent2/check-your-answers-post/", (req, res) => {
...
router.post("/beta/v10-copy/parent2/check-answers-kickout-post/", (req, res) => {
